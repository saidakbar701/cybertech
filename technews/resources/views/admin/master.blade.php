...
<body>
    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html"><span
                class="logo-name"><img src="{{ asset('temp/images/logo.png') }}" alt=""></span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown">
              <a href="{{ route('dashboard.page') }}" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown">
              <a href="{{ route('admin.categories.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Categories</span></a>
            </li>
            <li class="dropdown">
              <a href="{{ route('admin.posts.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Category Posts</span></a>
            </li>
            <li class="dropdown">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          <a href="https://t.me/Khasanov_SF">Designed by Khasanov</a></a>
        </div>
  ...
  <script>
    ...
    let b = document.querySelectorAll("[href = '"+url+"']")[0]; 
