                  ...
                  <div class="card-body">
                    ...
                    @method('PUT')
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="{{ $ad->title }}" name="title" class="form-control"></input>
                        </div>

                        <div class="form-group">
                            <label>Url</label>
                            <input type="text" value="{{ $ad->url }}" name="url" class="form-control"></input>
                        </div>

                        <div class="form-group">
                            <label>Ads Rasmi</label>
                            <input type="file" src="{{ asset('temp/img/'.$ad->image) }}" name="image" class="form-control">
                        </div>
